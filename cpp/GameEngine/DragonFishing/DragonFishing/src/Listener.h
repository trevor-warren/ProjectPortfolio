...
namespace Audio
{
  class Listener : public Engine::Object
  {
  public:
    ...
    /******************************************************************************/
    /*!
    \fn MakeActiveListner
    \brief Makes this listener the active listner. An active listner is one that
    updates the position of the audio systems internal listner to determine audio
    attenuation and left-right stereo splitting

    */
    /******************************************************************************/
    void MakeActiveListener();
    
    /******************************************************************************/
    /*!
    \fn IsActive
    \brief Checks if this listener is the active listener

    \return
    True if the listner is active, false otherwise
    */
    /******************************************************************************/
    bool IsActive();
  ...
  private:
    ...
    static unsigned nextListenerID;
  };
}
...
namespace Engine
{
  ...
  */
  //Class_Inherits(Audio::Listener, Engine::Object);
}
