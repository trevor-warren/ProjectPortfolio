...
namespace Engine
{
	void InitializeObjectTypes()
	{
		...
		// Audio objects and types
		Register_Class(Audio::SoundDefinition);
		Register_Class(Audio::SoundEmitter);
		Register_Class(Audio::Listener);

		// Collision and Game Logic
		Register_Class(Collider);
		Register_Class(GameLogic::WormSegment);
		Register_Class(GameLogic::PlayerLogic);
